...
extern "C" export ActorBlueprint blueprint = {
    .flags = 0,
    .maxHP = hp,
    .type = ACTOR_TYPE_GOOMBO,
    .level = ACTOR_LEVEL_GOOMBO,
...
s32 DefaultAnims[] = {
    STATUS_KEY_NORMAL,    ANIM_Goombo_Idle,
    STATUS_KEY_STONE,     ANIM_Goombo_Still,
    STATUS_KEY_SLEEP,     ANIM_Goombo_Sleep,
    STATUS_KEY_POISON,    ANIM_Goombo_Idle,
    STATUS_KEY_STOP,      ANIM_Goombo_Still,
    STATUS_KEY_STATIC,    ANIM_Goombo_Idle,
    STATUS_KEY_PARALYZE,  ANIM_Goombo_Still,
    STATUS_KEY_DIZZY,     ANIM_Goombo_Dizzy,
    STATUS_KEY_UNUSED,    ANIM_Goombo_Dizzy,
    STATUS_END,
};

// while shuffling around during idle
s32 ShuffleAnims[] = {
    STATUS_KEY_NORMAL,    ANIM_Goombo_Run,
    STATUS_KEY_STONE,     ANIM_Goombo_Still,
    STATUS_KEY_SLEEP,     ANIM_Goombo_Sleep,
    STATUS_KEY_POISON,    ANIM_Goombo_Idle,
    STATUS_KEY_STOP,      ANIM_Goombo_Still,
    STATUS_KEY_STATIC,    ANIM_Goombo_Run,
    STATUS_KEY_PARALYZE,  ANIM_Goombo_Still,
    STATUS_KEY_DIZZY,     ANIM_Goombo_Dizzy,
    STATUS_KEY_UNUSED,    ANIM_Goombo_Dizzy,
    STATUS_END,
...
EvtScript EVS_HandleEvent = {
    ...
    Switch(LVar0)
        ...
        CaseOrEq(EVENT_HIT)
            ...
            SetConst(LVar1, ANIM_Goombo_Hurt)
            ExecWait(EVS_Enemy_Hit)
        EndCaseGroup
        CaseEq(EVENT_BURN_HIT)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goombo_BurnHurt)
            SetConst(LVar2, ANIM_Goombo_BurnStill)
        ...
        CaseEq(EVENT_BURN_DEATH)
            ...
            ExecWait(EVS_Enemy_BurnHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goombo_BurnStill)
        ...
        CaseEq(EVENT_SPIN_SMASH_DEATH)
            ...
            ExecWait(EVS_Enemy_SpinSmashHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goombo_Dead)
            ExecWait(EVS_Enemy_Death)
            Return
        CaseEq(EVENT_SHOCK_HIT)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goombo_Electrocute)
        ...
        CaseOrEq(EVENT_AIR_LIFT_FAILED)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goombo_Idle)
        ...
        CaseEq(EVENT_SCARE_AWAY)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Goombo_Run)
            SetConst(LVar2, ANIM_Goombo_Hurt)
